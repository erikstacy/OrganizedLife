...
public class MonthAdapter extends BaseAdapter {
    ...
    public static ArrayList<Month> monthList;

    public MonthAdapter(Context context, ArrayList<Month> month) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.titleView.setText(monthList.get(position).getMonthTitle());
        ...
        holder.titleView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                monthList.get(position).setMonthTitle(holder.titleView.getText().toString());
            }
