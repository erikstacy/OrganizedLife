...
public class DayAdapter extends BaseAdapter {
    ...
    public static ArrayList<Day> dayList;

    public DayAdapter(Context context, ArrayList<Day> day) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.titleView.setText(dayList.get(position).getDayTitle());
        ...
        holder.titleView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                dayList.get(position).setDayTitle(holder.titleView.getText().toString());
            }
